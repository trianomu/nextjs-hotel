...
export default function SearchPage() {
  ...
  useEffect(() => {    
    setSearchData({
        selectedCity: searchParams.get("city_id") ? Number(searchParams.get("city_id")) : null,
        date: searchParams.get("date") ? [new Date(searchParams.get("date")!)] : null,
        dates: calculateDateRange(searchParams.get("date"), parseInt(searchParams.get("night") || "1", 10)),
